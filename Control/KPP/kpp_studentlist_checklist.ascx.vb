...
Public Class kpp_studentlist_checklist
    ...
    Private Function getSQL() As String
        ...
        If kpp_check_ans = "Y" Then
            tmpSQL = "select instruktor_marklist.insMarkList_id,instruktor_marklist.std_id,instruktor_marklist.marks
                    ...
                    left join instruktorExam_result_kpp on instruktor_marklist.std_id = instruktorExam_result_kpp.std_id
                    where instruktor_marklist.insMarkList_id is not null and instruktor_marklist.std_id ='" & decrypt_studentid & "'
    ...
    Private Sub getData()
        ...
        Dim get_komenKPP As String = "select instruktorExam_Komen_kpp from instruktorExam_result_kpp where std_id = '" & decrypt_studentid & "' and instruktorExam_year = '" & Now.Year & "'"
        Dim find_komenKPP As String = oCommon.getFieldValue(get_komenKPP)

        txt_Comment.Text = find_komenKPP

        Dim get_pencapaianKPP As String = "select instruktorExam_Pencapaian from instruktorExam_result_kpp where std_id = '" & decrypt_studentid & "' and instruktorExam_year = '" & Now.Year & "'"
        Dim find_pencapaianKPP As String = oCommon.getFieldValue(get_pencapaianKPP)

        txtPencapaian.Text = find_pencapaianKPP

        Dim get_sokongKPP As String = "select isSokong_KPP from instruktorExam_result_kpp where std_id = '" & decrypt_studentid & "' and instruktorExam_year = '" & Now.Year & "'"
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        If btnSimpan.Text = "Kembali" Then
            Response.Redirect("Control/kpp.studentlist.aspx")
        Else
            If checkAllchecked() = True Then
                If validate() = True Then
                    ...
                    SqlTotalMarks = "insert into instruktorExam_result_kpp (instruktorExam_marks,instruktorExam_Komen_kpp,instruktorExam_Pencapaian
                                        ,isSokong_kpp,std_id,instruktorExam_type_kpp,instruktorExam_year,stf_id) values ('" & totalvalue & "','" & txt_Comment.Text & "',
    ...
    Private Function upadateStudentStatus() As Boolean
        ...
        strSQL = "Update student_info set Kpp_update = 'Y' where std_id = '" & decryptid & "'"
